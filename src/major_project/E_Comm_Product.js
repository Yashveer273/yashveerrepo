...
console.log(value)
  ...
  useEffect(() => {
    fetch("http://localhost:5000/abc").then((Result) => {
      Result.json().then((resp) => {
        setProduct(resp);
        console.log(resp,"hhvhgvh");
      });
    });
    ...
    <>
      ...
      <div>
        <div className="sq">
          ...
          >
            <span style={{ fontSize: "2.5rem" }}>Personal Care</span>
            <hr
              style={{
                backgroundColor: "#acdbe5",
                width: "990px",
                borderTop: "2px solid",
              }}
            />
        ...
        >
          <span style={{ fontSize: "2.5rem" }}>Bundles</span>
          <hr
            style={{
              backgroundColor: "#acdbe5",
              width: "995px",
